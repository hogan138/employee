...
import com.wanchang.employee.ui.classify.ImageTextFragment;
import com.wanchang.employee.ui.classify.SpecsParamsFragment;
        ...
        .execute(new StringDialogCallback(mContext) {
          ...
          public void onSuccess(Response<String> response) {
            ...
            if (response.code() == 200) {
              ...
              mTabLayout.setTabData(mTabEntities, ProductDetail_SalesmanActivity.this, R.id.fl_change, mFragments);
            }
          }
        });
  }
