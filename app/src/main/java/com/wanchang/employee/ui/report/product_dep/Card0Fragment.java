...
public class Card0Fragment extends BaseFragment {
  ...
  public Card0Fragment() {
    // Required empty public constructor
  }

  public static Card0Fragment newInstance(String params) {
    Bundle args = new Bundle();
    args.putString(BUNDLE_ARGS, params);
    Card0Fragment fragment = new Card0Fragment();
  ...
  protected void initData() {
    mAdapter = new ExpandableProductDep0Adapter(null);
    ...
    mRv.addItemDecoration(new HorizontalDividerItemDecoration.Builder(mContext).visibilityProvider(
        new VisibilityProvider() {
          ...
          public boolean shouldHideDivider(int position, RecyclerView parent) {
            ...
            if (mAdapter.getItem(position) instanceof ProductDep01Item) {
              return true;
            } else {
              return false;
            }
  ...
  protected void initView() {
    View headerView = getLayoutInflater().inflate(R.layout.view_product_dep_card0_header, null);
  ...
  private void getProductChart() {
    OkGo.<String>get(MallAPI.CHART_PRODUCT_CHART)
        .tag(this)
        ...
        .execute(new StringDialogCallback(mContext) {
          ...
          public void onSuccess(Response<String> response) {
            ...
            if (response.code() == 200) {
              ...
              List<ProductDep0> productList = JSON.parseArray(jsonObj.getString("items"), ProductDep0.class);
              for (int i = 0; i < productList.size(); i++) {
                ProductDep00Item lv0 = new ProductDep00Item(productList.get(i));
                lv0.addSubItem(new ProductDep01Item(productList.get(i)));
                res.add(lv0);
              }
  ...
  public void getProductHeader() {
    OkGo.<String>get(MallAPI.CHART_PRODUCT_HEADER)
        .tag(this)
        .execute(new StringDialogCallback(mContext) {
          ...
          public void onSuccess(Response<String> response) {
            ...
            if (response.code() == 200) {
              ...
              headerViewHolder.mAddProductTv.setText(jsonObj.getString("add_product"));
            }
          }
