...
import com.wanchang.employee.data.entity.ProductDep1;
...
public class Card1Fragment extends BaseFragment {
  ...
  private ExpandableProductDep1Adapter mAdapter;
  ...
  public static Card1Fragment newInstance(String params) {
  ...
  protected void initData() {
    mAdapter = new ExpandableProductDep1Adapter(null);
    ...
    mRv.addItemDecoration(new HorizontalDividerItemDecoration.Builder(mContext).visibilityProvider(
        new VisibilityProvider() {
          ...
          public boolean shouldHideDivider(int position, RecyclerView parent) {
            ...
            if (mAdapter.getItem(position) instanceof ProductDep11Item) {
              return true;
            } else {
              return false;
            }
  ...
  private void getProductChart() {
    OkGo.<String>get(MallAPI.SYS_CHART_SALESMAN_CHART)
        .tag(this)
        ...
        .execute(new StringDialogCallback(mContext) {
          ...
          public void onSuccess(Response<String> response) {
            ...
            if (response.code() == 200) {
              ...
              List<ProductDep1> productList = JSON.parseArray(jsonObj.getString("items"), ProductDep1.class);
              for (int i = 0; i < productList.size(); i++) {
                ProductDep10Item lv0 = new ProductDep10Item(productList.get(i));
                lv0.addSubItem(new ProductDep11Item(productList.get(i)));
                res.add(lv0);
              }
