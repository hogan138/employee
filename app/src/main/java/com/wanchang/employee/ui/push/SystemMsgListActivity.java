...
public class SystemMsgListActivity extends BaseActivity{
  ...
  protected void initData() {
    ACache.get(mContext).remove(Constants.KEY_NEW_MSG_1);
...
//        getResources().getColor(R.color.color_e5)).build());
    mSystemRv.setAdapter(mAdapter = new BaseQuickAdapter<Message, BaseViewHolder>(R.layout.item_system_msg_list) {
      @Override
