...
import com.wanchang.employee.data.entity.AreaCard;
 ...
 */
public class CardAreaFragment extends BaseFragment {
  ...
  private ExpandableAreaCardAdapter mAdapter;
  ...
  public CardAreaFragment() {
    // Required empty public constructor
  }

  public static CardAreaFragment newInstance(String params) {
    Bundle args = new Bundle();
    args.putString(BUNDLE_ARGS, params);
    CardAreaFragment fragment = new CardAreaFragment();
  ...
  protected void initData() {
    mAdapter = new ExpandableAreaCardAdapter(null);
    ...
    mRv.addItemDecoration(new HorizontalDividerItemDecoration.Builder(mContext).visibilityProvider(
        new VisibilityProvider() {
          ...
          public boolean shouldHideDivider(int position, RecyclerView parent) {
            ...
            if (mAdapter.getItem(position) instanceof AreaCard1Item) {
              return true;
            } else {
              return false;
            }
  ...
  private void getProductChart() {
    OkGo.<String>get(MallAPI.CHART_AREA_CHART)
        .tag(this)
        ...
        .execute(new StringDialogCallback(mContext) {
          ...
          public void onSuccess(Response<String> response) {
            ...
            if (response.code() == 200) {
              ...
              List<AreaCard> productList = JSON.parseArray(jsonObj.getString("items"), AreaCard.class);
              for (int i = 0; i < productList.size(); i++) {
                AreaCard0Item lv0 = new AreaCard0Item(productList.get(i));
                lv0.addSubItem(new AreaCard1Item(productList.get(i)));
                res.add(lv0);
              }
