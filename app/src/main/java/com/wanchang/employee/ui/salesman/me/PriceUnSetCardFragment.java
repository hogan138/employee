 ...
 */
public class PriceUnSetCardFragment extends BaseFragment {
  ...
  public PriceUnSetCardFragment() {
    // Required empty public constructor
  }

  public static PriceUnSetCardFragment newInstance(String clientId) {
    Bundle args = new Bundle();
    args.putString("clientId", clientId);
    PriceUnSetCardFragment fragment = new PriceUnSetCardFragment();
  ...
  protected void initData() {
    ...
    mOrderRv.setAdapter(mOrderAdapter = new BaseQuickAdapter<Product, BaseViewHolder>(R.layout.item_price_un_set_card_list) {
      @Override
