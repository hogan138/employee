package com.wanchang.employee.easemob.ui;
...
import com.wanchang.employee.easemob.widget.EaseChatRecallPresenter;
import com.wanchang.employee.easemob.widget.EaseChatVoiceCallPresenter;
import com.wanchang.employee.ui.MainActivity;
import com.wanchang.employee.ui.salesman.news.GroupChatSettingActivity;
import com.wanchang.employee.ui.salesman.news.SingleChatSettingActivity;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper{
    ...
    protected void setUpView() {
        ...
        super.setUpView();
        titleBar.setBackgroundColor(getResources().getColor(R.color.color_ff));
...
//                                putExtra("groupId", toChatUsername), REQUEST_CODE_SELECT_AT_USER);
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            titleBar.setRightImageResource(R.drawable.nav_chatset);
        } else {
            titleBar.setRightImageResource(R.drawable.nav_gchatset);
        }
        ...
        titleBar.setRightLayoutClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
                    startActivity(new Intent(getContext(), SingleChatSettingActivity.class)
                        .putExtra("im_account", toChatUsername));
                } else {
                    startActivity(new Intent(getContext(), GroupChatSettingActivity.class)
                        .putExtra("im_group_id", toChatUsername));
                }
            }
        });
    }
...
//        }
        LoginInfo loginInfo = (LoginInfo) ACache.get(getContext()).getAsObject(Constants.KEY_LOGIN_INFO);
        String from_name = loginInfo.getUser().getName();
        String from_avatar = loginInfo.getUser().getPic();
        message.setAttribute(Constant.EXTRA_FROM_NAME, from_name);
        message.setAttribute(Constant.EXTRA_FROM_AVATAR, from_avatar);
    }
