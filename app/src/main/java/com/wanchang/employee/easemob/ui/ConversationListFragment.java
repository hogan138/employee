        ...
        conversationListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (username.equals(EMClient.getInstance().getCurrentUser()))
                    ...
                    handleMessage(username, conversation);
                }
            }
        });
...
//                }
    ...
    private void handleMessage(String username, EMConversation conversation) {
        if (Constant.IM_EXT_TYPE_ORDER.equals(username)) {
            ToastUtils.showShort("订单消息");
        } else if (Constant.IM_EXT_TYPE_SYSTEM.equals(username)) {
            ToastUtils.showShort("系统消息");
        } else if (Constant.IM_EXT_TYPE_PROMOTION.equals(username)) {
            ToastUtils.showShort("采购资讯");
        } else {
